...
Rect chooseBox(vector <pair<Rect, float>> predicted_boxes) {
	...
	float threshold = 0.5; // Threshold for selecting IoU of each pair predicted boxes to caculate other_predict
...
int main() {
	...
	vector<pair<int, int>> anchor = { {40, 100}, {75, 100}, {100, 40}, {100, 75}, {100, 100} };
	// Load trained model
	...
	/*
	// Load test image to dectect polyps
	String path = "original_data\\0.jpg";
	Rect actual_box = actual_boxes[0];
